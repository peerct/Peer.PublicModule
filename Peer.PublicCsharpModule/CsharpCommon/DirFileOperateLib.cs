...
namespace Peer.PublicCsharpModule.CsharpCommon
{
    ...
    /// 文件和文件夹操作
    /// </summary>
    public static class DirFileOperateLib
    {
        #region 检测指定目录是否存在
        /// <summary>
        /// 检测指定目录是否存在
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "\\" + dir))
                Directory.CreateDirectory(System.AppDomain.CurrentDomain.BaseDirectory + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "\\" + dir))
                Directory.Delete(System.AppDomain.CurrentDomain.BaseDirectory + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteFile(string file)
        {
            if (File.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "\\" + file))
                File.Delete(System.AppDomain.CurrentDomain.BaseDirectory + "\\" + file);
        }
        #endregion
        ...
        public static void WriteText(string FilePath, string Content, int WriteType, Encoding Enc)
        {
            try
            {
