...
{
   public  class XmlReadLib
    {
       #region 构造函数
           public XmlReadLib(string strPath)
           {
       ...
       #region 公有属性
           ...
           /// 使用示列:
           /// XMLProsess.Insert("/Node", "Element", "", "Value")
           /// XMLProsess.Insert( "/Node", "Element", "Attribute", "Value")
           ...
           public  void Insert( string node, string element, string[][] strList)
           {
               try
               {
                   XmlDocument doc = XMLLoad();
           ...
           /// <param name="value">值</param>
           /// 使用示列:
           /// XMLProsess.Delete( "/Node", "")
           /// XMLProsess.Delete( "/Node", "Attribute")
